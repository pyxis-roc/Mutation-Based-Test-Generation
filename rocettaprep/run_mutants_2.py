...
if __name__ == "__main__":
    ...
    p.add_argument("--r2source", help="Source for second round tests", choices=['eqvcheck', 'fuzzer_simple', 'fuzzer_custom'])
    ...
    if args.round2 and not args.r2source:
        args.r2source = 'eqvcheck'
